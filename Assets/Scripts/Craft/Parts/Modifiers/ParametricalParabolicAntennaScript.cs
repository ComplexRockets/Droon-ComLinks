namespace Assets.Scripts.Craft.Parts.Modifiers
{
    ...
    public class ParametricalParabolicAntennaScript : PartModifierScript<ParametricalParabolicAntennaData>, IDCLAntennaScript {
        ...
        private string _path = "Assets/Content/Craft/Parts/Meshes/ParametricalAntenna/Prefabs/";
        ...
        private List<GameObject> _secondaryAttachPoints = new List<GameObject> ();
        private List<GameObject> _doubleAttachPoints = new List<GameObject> ();
        private List<GameObject> _structureRidge = new List<GameObject> ();
        private List<GameObject> _structureBottomRidge = new List<GameObject> ();
        private List<GameObject> _structureSide = new List<GameObject> ();
        private List<GameObject> _structureSideOffset = new List<GameObject> ();
        private List<GameObject> _crossStrucure1A = new List<GameObject> ();
        private List<GameObject> _crossStrucure2A = new List<GameObject> ();
        private List<GameObject> _crossStrucure1B = new List<GameObject> ();
        private List<GameObject> _crossStrucure2B = new List<GameObject> ();
        ...
        public void Initialize (DCLAntennaData AntennaData, float size) {
            ...
            _cylinderPrefab = _mod.ResourceLoader.LoadAsset<GameObject> (_path + "Cylinder.prefab");
        ...
        public void UpdateAntenna () {
            ...
            _upperElement.Object.transform.localPosition = new Vector3 (0, Data.focalLength, 0);
            _upperElement.Object.transform.localScale = new Vector3 (Data.radius, Data.radius, Data.radius);
            if (Data.secondaryReflector) _lowerElement.Object.transform.localScale = new Vector3 (Data.radius, Data.radius, Data.radius);
        ...
        private void UpdateUpperStructure () {
            ...
            float YPos = Data.focalLength + _upperElement.Offset.x * Data.radius / 2;
